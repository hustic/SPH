...
public:
	...
	void place_points_new(double min0, double min1, double max0, double max1, bool type);
	...
	vector<vector<double>> boundaries;		//boundaries
	vector<vector<double>> vertices;		//verticies of the polygon
	vector<vector<double>> areas;			//areas of moving particles
